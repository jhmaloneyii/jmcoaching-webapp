class Admin::ProductTypesController < Admin::AdminController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_product_types_url, notice: 'Product type was successfully destroyed.' }
  ...
  private
    ...
    def product_type_params
      params.require(:product_type).permit(:name, fields_attributes: ProductField.attribute_names.map(&:to_sym).push(:_destroy))#[:id, :_destroy, :product_type_id, :field_type, :name, :required])
    end
end
